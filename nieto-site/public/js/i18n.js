...
const translations = {
  'pt-BR': {
    ...
    'hero.title': 'Construímos marcas <strong>fortes, estratégicas e memoráveis</strong> para profissionais da saúde mental',
    'hero.subtitle': 'Unimos identidade visual, gestão de marca, fotografia, decoração de ambientes e criação de sites para desenvolver marcas sólidas, com presença, consistência e valor em cada ponto de contato.',
  ...
  'en': {
    ...
    'hero.title': 'We build <strong>strong, strategic and memorable</strong> brands for mental health professionals',
    'hero.subtitle': 'We combine visual identity, brand management, photography, environment design and web development to create solid brands with presence, consistency and value at every touchpoint.',
